...
\centering
	...
	\caption{File Storage: Aufbau des Hierarchiesystems, \citeurl{rH-storage}}
\end{figure}
...
\cline{1-2}
\end{tabular}
\caption{Verfügbarkeit der Speicherklassen gemäß GC Storage SLA, \citeurl{gcp-sla}}
\end{table}
