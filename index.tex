...
\include{./Bibtex/Biblatexanpassungen.tex}
...
%Include
%****************************************
\include{./Deckblatt/Deckblatt}		% Deckblatt
\include{./Erklaerung/Erklaerung} 	% Erklärung
\include{./Abstract/Abstract} 		% Abstract
...
\include{./TheoretischerTeil/TheoretischerTeil}
\include{./PraktischerTeil/PraktischerTeil}
\include{./Ergebnisse/Ergebnisse}
